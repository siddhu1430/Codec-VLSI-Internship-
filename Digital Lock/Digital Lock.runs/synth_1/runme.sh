...
HD_PWD='C:/Users/dsidd/Digital Lock/Digital Lock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_lock.tcl
